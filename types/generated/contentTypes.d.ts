...
export interface ApiDepartmantDepartmant extends Schema.CollectionType {
  collectionName: 'departmants';
  info: {
    singularName: 'departmant';
    pluralName: 'departmants';
...
export interface ApiLessonLesson extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    description: Attribute.String & Attribute.Required;
    lesson_code: Attribute.String & Attribute.Required;
    lessons_scheduler: Attribute.Relation<
      'api::lesson.lesson',
      'manyToOne',
      'api::lessons-scheduler.lessons-scheduler'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiLessonsSchedulerLessonsScheduler
  extends Schema.CollectionType {
  collectionName: 'lessons_schedulers';
  info: {
  ...
  attributes: {
    ...
    finish_time: Attribute.DateTime & Attribute.Required;
...
export interface ApiStudentStudent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    card_id: Attribute.BigInteger & Attribute.Required;
...
export interface ApiStudentControlStudentControl extends Schema.CollectionType {
  collectionName: 'student_controls';
  info: {
...
export interface ApiUserLessonUserLesson extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::departmant.departmant': ApiDepartmantDepartmant;
      'api::lesson.lesson': ApiLessonLesson;
      'api::lessons-scheduler.lessons-scheduler': ApiLessonsSchedulerLessonsScheduler;
      'api::program.program': ApiProgramProgram;
      'api::school.school': ApiSchoolSchool;
      'api::student.student': ApiStudentStudent;
      'api::student-control.student-control': ApiStudentControlStudentControl;
